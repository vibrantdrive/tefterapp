...
<div class="group">
	<label for="yahoo_login_url">{$lang.label_login_url}</label>
	<input type="text" name="yahoo_login_url" id="yahoo_login_url" value="{$account_type.account_type_login_url}" disabled="disabled" />
</div>