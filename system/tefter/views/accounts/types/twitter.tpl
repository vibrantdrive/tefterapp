...
<div class="group">
	<label for="twitter_login_url">{$lang.label_login_url}</label>
	<input type="text" name="twitter_login_url" id="twitter_login_url" value="{$account_type.account_type_login_url}" disabled="disabled" />
</div>