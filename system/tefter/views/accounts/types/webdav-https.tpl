...
">
	<div class="group">
		...
		<input type="text" name="port" id="port" autocomplete="off" value="{if $mode eq 'add'}{if isset($posted)}{$posted.port}{else}443{/if}{else}{if $mode eq 'edit'}{if $posted.port neq ''}{$posted.port}{else}{$account.port}{/if}{/if}{/if}" />
