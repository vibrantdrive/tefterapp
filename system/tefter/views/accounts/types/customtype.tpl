...
<div class="group">
    ...
    <input type="text" name="login_url" id="login_url" value="{if $mode eq 'add'}{if isset($posted)}{$posted.login_url}{/if}{else}{if $mode eq 'edit'}{if $posted.login_url neq ''}{$posted.login_url}{else}{$account.login_url}{/if}{/if}{/if}" />
</div>
