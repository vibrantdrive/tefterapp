<div class="group">
	...
	<input type="text" name="server" id="server" autocomplete="off" value="{$lang.text_server_amazons3}" />
	<p class="hint">{$lang.text_server_amazons3_hint}</p>
</div>

<div class="group">
	<div class="half-width separator">
		<label for="username" class="required">{$lang.label_access_key}</label>
	...
	<div class="half-width">
		<label for="password" class="required">{$lang.label_secret}</label>
