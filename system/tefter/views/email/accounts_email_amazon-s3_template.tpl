								...
								<tr>
									...
									<td valign="top">
										...
										<table cellpadding="0" cellspacing="0" border="0" width="100%" style="background: #FFFFCC; padding: 15px 15px 0 15px; border: 1px solid #FFD886;">
											<tr>
												<td>
													<p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.text_protocol}: <strong>{$account.account_type_name}</strong></p>
													
													<p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.label_server}: <strong>{$account.server}</strong></p>
													
													<p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.label_access_key}: <strong>{$account.username}</strong></p>
													
													<p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.label_secret}: <strong>{$account.password}</strong></p>
													
													<p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.text_port}: <strong>{$account.port}</strong></p>
													
													{if $account.passive_mode eq 1}<p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.text_use_passive_mode}: <strong>Yes</strong></p>{/if}
													
													<p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.text_root_url}: <strong>{$account.root_url}</strong></p>
													
													<p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.text_remote_path}: <strong>{$account.remote_path}</strong></p>
												</td>
											</tr>
										</table>
									</td>
