...
<head>
  ...
  <title>Your sign in details have been edited</title>
</head>
	  	...
	  	<td align="center">
		    ...
		    <table cellpadding="0" cellspacing="0" border="0" align="center" width="600" style="background: #426898;">
	        	...
	        	<td width="580" align="left" style="padding: 18px 0;">
							<h1 style="color: #eeeeee; font-size: 32px; line-height: 40px; margin: 0; padding: 0;">Your sign in details have been edited</h1>
	        	</td>
	      	</tr>
				</table>
		        ...
		        <td width="600" valign="top" align="left" style="padding: 20px 0 0;">
							...
							<table cellpadding="0" cellspacing="0" border="0" width="600">
								...
								<tr>
									<td width="21" style="font-size: 1px; line-height: 1px;"></td>
									<td valign="top">
										<p style="font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$editingUser.name_first} {$editingUser.name_last} edited your login details in our login management system. All you need to do is to click on the following URL and sign in with new details.</p>
