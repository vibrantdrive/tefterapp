								...
								<tr>
									...
									<td valign="top">
										...
										<table cellpadding="0" cellspacing="0" border="0" width="100%" style="background: #FFFFCC; padding: 15px 15px 0 15px; border: 1px solid #FFD886;">
											<tr>
												<td>
													<p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.label_email}: <strong>{$account.email}</strong></p>
																										
													<p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.label_email_type}: <strong>{$account.email_type}</strong></p>
													
													<p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.label_incoming_mail_server}: <strong>{$account.incoming_mail_server}</strong></p>
													
													<p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.label_username}: <strong>{$account.incoming_username}</strong></p>
													
													<p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.label_password}: <strong>{$account.incoming_password}</strong></p>
													
													<p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.label_outgoing_mail_server}: <strong>{$account.outgoing_mail_server}</strong></p>
													
													<p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.label_username}: <strong>{$account.outgoing_username}</strong></p>
													
													<p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.label_password}: <strong>{$account.outgoing_password}</strong></p>
												</td>
											</tr>
										</table>
									</td>
