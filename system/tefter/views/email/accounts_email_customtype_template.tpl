                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background: #FFFFCC; padding: 15px 15px 0 15px; border: 1px solid #FFD886;">
                                            <tr>
                                                <td>                                                                                                        
                                                    <p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.label_login_url}: <strong>{$account.login_url}</strong></p>
                                                    ...
                                                    {if $account.note neq ''}<p style="color: #333333; font-size: 12px; line-height: 20px; margin: 0 0 15px 0; padding: 0;">{$lang.label_instructions}: <strong>{$account.note}</strong></p>{/if}
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
